...
```bibtex
@software{Susanto2025BYEBAC,
  author = {Susanto, Caroline},
  title = {BYE BAC: AI-Powered Broken Access Control Detection Agent},
  year = {2025},
  url = {https://github.com/Carolinesnt/ai_agent_starter},
  version = {1.0.0}
}
```
...
**APA Format:**
```
Susanto, C. (2025). BYE BAC: AI-Powered Broken Access Control Detection Agent (Version 1.0.0) [Computer software]. GitHub. https://github.com/Carolinesnt/ai_agent_starter
```

For more citation formats, click the **"Cite this repository"** button on GitHub.
...
**Legal Disclaimer:**
This software is provided "as is" without warranty. The author is not responsible for any misuse or damage caused by this tool. Users are solely responsible for ensuring compliance with all applicable laws and regulations in their jurisdiction.
...
- **Current Version**: `v1.0.0` - Initial release for academic publication
- **Release Tag**: `v1.0.0-peerj` - PeerJ submission version

### Important for Reproducibility

When citing this work in academic papers, please specify the version:
- For reproducibility, use the release version tag
- All releases are archived and available on GitHub
- Source code for each version is permanently accessible

**To use a specific version:**
```bash
git clone https://github.com/Carolinesnt/ai_agent_starter.git
cd ai_agent_starter
git checkout v1.0.0-peerj  # Use specific release
```
...
- **Research Focus**: API Security, Broken Access Control Detection, AI-Powered Security Testing
- **Project**: BYE BAC - AI-Powered BAC Vulnerability Detection Agent
